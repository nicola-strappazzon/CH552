...
To demonstrate how DataFlash is used, a base example [Button & LED RGB](/src/button_led_rgb) was modified to save the last color state. If the MCU is reset or disconnected, it will retain the last state.
